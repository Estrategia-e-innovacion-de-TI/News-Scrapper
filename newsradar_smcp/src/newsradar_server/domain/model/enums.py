"""Extensible enums for News Radar domain.

Extracted from extractor/enums.py. Enums define the base sets;
categories can be extended via YAML without code changes.
"""
...
# ── Base sets (defaults when YAML is absent) ─────────────────────────
...
def get_valid_categories(
    ...
    *,
    ...
    Falls back to base enum values if the YAML file is not found.
    """
    if query_type == "aras":
        try:
